...
This is a ToDo app with all front-end functionality develop in React.
...
```PowerShell
git clone git@github.com:tizor98/to-do.git
```
...
To serve the production folder in a local environment.
